...
public class Solution_tier4_10828 {
	...
	private void solution_1() throws Exception {
		...
		for(int i = 0; i < loop; i ++) {
			...
			doCommand(stack_1, command);
		}
		
	}
	
	private void doCommand(Stack<Integer> stack, String command) throws Exception{
	...
	public static void main(String[] args) throws Exception{
		...
		new Solution_tier4_10828().solution_1();
